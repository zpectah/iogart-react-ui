...
export type DivElement = DetailedHTMLProps<
...
export type LinkElement = DetailedHTMLProps<
  ...
  HTMLLinkElement
>;
export type AnchorElement = DetailedHTMLProps<
  HTMLAttributes<HTMLAnchorElement>,
  HTMLAnchorElement
>;
export type ButtonElement = DetailedHTMLProps<
  HTMLAttributes<HTMLButtonElement>,
  HTMLButtonElement
>;
export type SpanElement = DetailedHTMLProps<
